                ...
                <div className="flex flex-col lg:flex-row justify-between w-11/12 lg:w-3/4 mx-auto lg:gap-8">
                    <div className="w-full lg:w-1/3">
                        ...
                        <div className="flex mt-5">
                            <p className="rounded-2xl bg-gray-500 py-2 px-4 text-white">Next.js</p>
                            <p className="rounded-2xl bg-gray-500 py-2 px-4 text-white ml-5">Tailwind</p>
                        </div>
                    </div>
                    <a href="https://eloken.com" className="hover:scale-110 transition duration-300">
                        <Image src={img1} width={img1.width / 5} height={img1.height} alt="/" />
                    </a>
                </div>
            </div>
            <div>
                ...
                <div className="flex flex-col-reverse lg:flex-row justify-between w-11/12 lg:w-3/4 mx-auto lg:gap-8">
                    <a href="https://trello.com" className="hover:scale-110 transition duration-300">
                        <Image src={img2} width={img2.width / 5} height={img2.height} alt="/" />
                    </a>
                    <div className="w-full lg:w-1/3">
                        <p className="font-Monserat text-2xl font-bold mb-4 lg:mb-8">
