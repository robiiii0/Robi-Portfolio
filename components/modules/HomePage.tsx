...
export default function HomePage() {
  ...
  const reset = useCallback(() => {
    ...
    ref.current = [];
    set([]);
    ref.current.push(setTimeout(() => set(["Hello"]), 600));
  }, []);
  ...
  return (
    <div className="bg-white">
      <header className="absolute inset-x-0 top-0 z-50">
        ...
        >
          <div className="flex lg:flex-1">
            <a href="#" className="-m-1.5 p-1.5">
              ...
              <Image
                ...
                src="https://media.licdn.com/dms/image/D4E03AQHEeqHhB2910g/profile-displayphoto-shrink_400_400/0/1680534100940?e=1689811200&v=beta&t=yuvpn9u4U9wkMe69PL4ZEZ4kx_plOX-bmPZO1oRi0W8"
                alt=""
              />
            </a>
          </div>
          ...
          <div className="hidden lg:flex lg:flex-1 lg:justify-end">
            <a
              href="#"
              className="text-sm transition ease-in-out duration-300 hover:scale-110 font-semibold leading-6 text-gray-900"
            >
      ...
      <div className="relative isolate px-6 pt-14 lg:px-8">
        ...
        <div className="w-full mx-auto py-32 sm:py-48 lg:py-52">
          <div className="text-center">
            ...
            <div className="w-2/4 mx-auto">
              <p className="mt-6 text-lg leading-8 text-gray-600">
                I&apos;m a passionate web developer focused on front-end
                development, and I&apos;m currently pursuing my studies at
                Epitech. With a strong dedication to crafting engaging and
