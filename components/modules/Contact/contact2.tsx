        ...
        <div>
            <div className="relative min-h-screen grid bg-black">
                <div className="flex flex-col sm:flex-row items-center md:items-start sm:justify-center md:justify-start flex-auto min-w-0">
                    <div className="relative sm:w-1/2 xl:w-3/5 bg-blue-500 h-full hidden md:flex flex-auto items-center justify-center p-10 overflow-hidden text-white bg-no-repeat bg-cover" style={{ backgroundImage: "url(/927EA8A3-9BFA-431A-86AE-08774F5139A9.jpg  )" }}>
                                ...
                                <div className="flex items-center justify-center">
                                    <div className="bg-black flex flex-col w-80 border border-gray-700 rounded-lg px-8 py-10">
                                        <form className="flex flex-col space-y-8 mt-10">
                                            <p className={"font-bold text-2xl text-white text-center"}>{isFrench ? 'me contacter' : 'contact me'}</p>
                                            <label className="font-bold text-lg text-white text-center">{isFrench ? 'Par Mail' : 'By Mail'}</label>
                                            ...
                                            <label className="font-bold text-lg text-white text-center">{isFrench ? 'Par Linkedin' : 'By Linkedin'}</label>
                                            <Transition.revealFromLeft>
                                                <a
                                            ...
                                            <label className="font-bold text-lg text-white text-center">{isFrench ? 'Mon Github' : 'My Github'}</label>
                                            <Transition.revealFromLeft>
                                                <a
