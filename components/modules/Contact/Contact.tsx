...
const EmailIcon = () => {
  return (
    <>
      <div className="flex justify-center mt-16 md:mt-36 space-x-20">
        <a
        ...
        <a
          href="https://mail.google.com/mail/?view=cm&fs=1&to=robindevpro1@gmail.com"
          className="text-red-500 flex flex-col items-center"
        >
          <Transition.reveal>
            <span>Here&apos;s my Gmail</span>
          </Transition.reveal>
          <Transition.reveal>
            <svg
              xmlns="http://www.w3.org/2000/svg"
